    ...
    public static partial class ValueTests
    {
        public class Controller : IDisposable
        {
            ...
            async Task Get()
            {
                ...
                var result = await controller.Get(lookup.CrazyKey);
            ...
            async Task Update()
            {
                ...
                var updateResult = await controller.Update(result.CrazyKey, ValueTests.CreateInput());
            ...
            async Task Delete()
            {
                ...
                await controller.Delete(result.CrazyKey);
