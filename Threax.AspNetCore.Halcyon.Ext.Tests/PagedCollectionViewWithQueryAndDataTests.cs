...
{
    public class PagedCollectionViewWithQueryAndDataTests
    {
        ...
        {
            public TestCollection(int collectionWideData, TestQuery query, int total, IEnumerable<Test> items) : base(query, total, items)
            {
                this.CollectionWideData = collectionWideData;
            }

            public int CollectionWideData { get; private set; }
        }
    }
}
